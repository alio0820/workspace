...
mxClient.link('stylesheet', 'css/common.css');
if (true) {
    document.namespaces.add('v', 'urn:schemas-microsoft-com:vml');
    document.namespaces.add('o', 'urn:schemas-microsoft-com:office:office');
    mxClient.link('stylesheet', 'css/explorer.css');// mxClient.basePath + '/
}
var mxLog = {
...
if (window.location.hostname != 'mxgraph.com' && window.location.hostname != 'www.mxgraph.com' && window.location.hostname != 'jgraph.com' && window.location.hostname != 'www.jgraph.com') {
    ...
    for (var i = 0, len = st.length, mxu = 'http://www.mxgraph.com/demo/mxgraph/src/js/mxclient.php', mxu2 = 'http://www.jgraph.com/demo/mxgraph/src/js/mxclient.php'; i < len && st[i].src.indexOf(mxu) < 0 && st[i].src.indexOf(mxu2) < 0; i++) 
        ;
    if (i == len) {
        if ((new Date().getTime() / 1000) - 1285926376 > 15778463) {
            mxGraph = null;
        };
...
function mxGraph(container, model, renderHint){
    ...
    if (false) {
        ...
        if (renderHint == mxConstants.RENDERING_HINT_EXACT && true) {
...
mxPanningHandler.prototype.init = function(){
    ...
    mxEvent.addListener(this.div, (mxClient.IS_TOUCH) ? 'touchmove' : 'mousemove', mxUtils.bind(this, function(evt){
        this.graph.tooltipHandler.hide();
    }));
};
...
/*
if ((eval('\156\145\167\40\104\141\164\145\50\51\56\147\145\164\124\151\155\145\50\51') / 1000) - 1285926313 > 31556859) {
    mxGraph = function(){
    };
};*/
var mxCodecRegistry = {
