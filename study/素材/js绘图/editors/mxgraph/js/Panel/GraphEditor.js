...
function main()
{
    ...
    ***************************************************************************/
    ...
    insertVertexTemplate(library, graph, '容器', 'images/swimlane.gif', 'swimlane', 200, 200, 'Container');//Container
    insertVertexTemplate(library, graph, '矩形', 'images/rectangle.gif', null, 100, 40);
    insertVertexTemplate(library, graph, '圆角矩形', 'images/rounded.gif', 'rounded=1', 100, 40);
    insertVertexTemplate(library, graph, '椭圆', 'images/ellipse.gif', 'ellipse', 60, 60);
    insertVertexTemplate(library, graph, '双椭圆', 'images/doubleellipse.gif', 'ellipse;shape=doubleEllipse', 60, 60);
    insertVertexTemplate(library, graph, '三角', 'images/triangle.gif', 'triangle', 40, 60);
    insertVertexTemplate(library, graph, '菱形', 'images/rhombus.gif', 'rhombus', 60, 60);
	insertVertexTemplate(library, graph, '水平线', 'images/hline.gif', 'line', 120, 10);
    insertVertexTemplate(library, graph, '六边形', 'images/hexagon.gif', 'shape=hexagon', 80, 60);
