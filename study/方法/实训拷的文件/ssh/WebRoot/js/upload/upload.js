...
function doSubmit(url){
	...
	thisForm.action = "upload-iframeRequest.whbs?url=" + encodeURI(url)+"&attachId="+attachId;
	thisForm.submit();
    startStatusCheck();
}
function emptyFile() {
...
function cancleFile() {
    ...
    xmlHttp.open("POST", "upload-ajaxRequest.whbs", true);
...
function startStatusCheck(){
    ...
    xmlHttp.open("POST", "upload-returnValue.whbs", true);
    xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
