...
CREATE TABLE `exam` (
  ...
  `examTime` int(8) DEFAULT NULL COMMENT '考试时间',
  `invigilate` varchar(16) DEFAULT NULL COMMENT '监考者',
  `inputUser` varchar(16) DEFAULT NULL,
  `inputTime` varchar(32) DEFAULT NULL,
...
INSERT INTO `exampaper_relative` VALUES ('2013092300000001', '2013092900000014', 'Judge', '011', null);
...
INSERT INTO `exampaper_relative` VALUES ('2013092300000004', '2013092900000021', 'MultipleChoice', '001', null);
...
INSERT INTO `role_info` VALUES ('000', '系统管理员', '1', '2013-10-23', 'cdzhai', null, null, null);
INSERT INTO `role_info` VALUES ('001', '培训学员', '1', '2013-10-23', 'cdzhai', null, null, null);
INSERT INTO `role_info` VALUES ('002', '试用员工', '1', '2013-10-23', 'cdzhai', null, null, null);
INSERT INTO `role_info` VALUES ('003', '正式员工', '1', '2013-10-23', 'cdzhai', null, null, null);
INSERT INTO `role_info` VALUES ('004', '管理员', '1', '2013-10-23', 'cdzhai', null, null, null);
INSERT INTO `role_info` VALUES ('005', '出卷人', '1', '2013-10-23', 'cdzhai', null, null, null);
...
INSERT INTO `topic_type` VALUES ('Blank', '填空题', '0003', '2013-08-11', '1', '每道题均有一处或多处空白，请在空白处填写答案');
INSERT INTO `topic_type` VALUES ('Judge', '判断题', '0004', '2013-08-11', '1', '请判断对错，对的打“∨”，错的打“×”');
INSERT INTO `topic_type` VALUES ('MultipleChoice', '多项选择题', '0002', '2013-08-11', '1', '每道题可能有多个选项，凡多选、少选、错选均不得分');
INSERT INTO `topic_type` VALUES ('SingleChoice', '单项选择题', '0001', '2013-08-11', '1', '每道题有且只有一个正确选项');
INSERT INTO `topic_type` VALUES ('Subjective', '主观题', '0005', '2013-08-11', '1', '请认真读题，并根据自己的理解作答');
