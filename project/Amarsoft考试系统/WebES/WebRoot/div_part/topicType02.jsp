...
<div id="MultipleChoice" class="box-content">
	...
	<fieldset>
	  ...
	  <div class="control-group answerDiv">
		  <label class="control-label" for="topicAnswer">试题答案</label>
			<div class="controls">
			  <select id="topicAnswer" data-placeholder="Choose the correct answer" multiple data-rel="chosen">
				<option>A</option>
				<option>B</option>
				<option>C</option>
				<option>D</option>
	  ...
	  <div class="form-actions">
		<button type="button" class="btn btn-primary" onclick="return as_save(2)">保存</button>
  ...
  <div class="row-fluid">
	  <div class="span12">
		<h2>Topic Preview</h2>
		<a style="text-decoration:none;cursor:pointer;" onclick="return topic_preview(2)">click here to see the preview of this topic:</a>
