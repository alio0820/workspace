...
<%
	List SubjectiveList = TopicBankAction.getSubjectiveAll();
	int size5  = SubjectiveList.size();
%>
<div id="Subjective" class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i> 题库-主观题</h2>
			<div class="box-icon">
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  <%
			  	for(int i=0;i<size5;i++){
			  		TopicBankBean tbb = (TopicBankBean)(SubjectiveList.get(i));
