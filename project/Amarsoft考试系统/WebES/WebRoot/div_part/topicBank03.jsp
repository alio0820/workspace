...
<%
	List BlankList = TopicBankAction.getBlankAll();
	int size3  = BlankList.size();
%>
<div id="Blank" class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i> 题库-填空题</h2>
			<div class="box-icon">
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  <%
			  	for(int i=0;i<size3;i++){
			  		TopicBankBean tbb = (TopicBankBean)(BlankList.get(i));
