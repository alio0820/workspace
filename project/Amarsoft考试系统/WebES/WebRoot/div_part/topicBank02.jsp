...
<%
	List MultipleChoiceList = TopicBankAction.getMultipleChoiceAll();
	int size2  = MultipleChoiceList.size();
%>
<div id="MultipleChoice" class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-user"></i> 题库-多项选择题</h2>
			<div class="box-icon">
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  <%
			  	for(int i=0;i<size2;i++){
			  		TopicBankBean tbb = (TopicBankBean)(MultipleChoiceList.get(i));
