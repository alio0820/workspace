...
<html>
	...
	<body class="body">
		<%
			...
			List ptbList = PaperAction.getPaperTopic(paperId);
		%>
		<div class="div_all">
		<div class="top">
			<div class="top_text">
		...
		<form name="form1" METHOD="POST">
			...
			<div>
				<div class="question">					
					...
					<BR/>
					<TABLE BORDER="0" CELLPADDING="5" CELLSPACING="0" style="border-top:1px dashed rgb(201,201,201);margin:8px 0 0 8px;">
						<TR>
							<TD class="small"> A.</TD>
							<TD> 国立女子师范学院	</TD>
						</TR>
