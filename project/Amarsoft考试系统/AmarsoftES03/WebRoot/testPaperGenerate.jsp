<%@page import="com.aes.beans.PaperBean"%>
<%@ page language="java" import="com.aes.action.PaperAction,java.util.List" pageEncoding="gbk"%>
<%
			  ...
			  <thead>
				  <tr>
					  ...
					  <th style='padding:3px;padding-left:-2px;'><span style="margin-top:5px;margin-left:5px;display:inline-block">动作</span>
					  	<a class="btn btn-success btn-circle" href="#" onclick="return as_add_paper('cdzhai'<%/*session.getAttribute("userName")*/%>)">
...
//			  		String updateUser = pb.getUpdateUser();
			  ...
			  %>
				<tr id="<%=examPaperId%>" class="cursor:pointer">
					...
					<td class="center">
						<a class="btn btn-success" onclick="return as_view_paper(this)">
