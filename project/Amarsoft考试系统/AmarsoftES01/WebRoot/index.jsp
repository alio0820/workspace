...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img alt="Charisma Logo" src="img/logo20.png" /> <span>Amarsoft</span></a>
	...
	<!-- topbar ends -->
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="javascript:void(0)" tar='ui'><i class="icon-folder-close"></i><span class="hidden-tablet"> 在线考试</span></a></li>
						...
						<li><a class="ajax-link" href="javascript:void(0)" tar='ui'><i class="icon-folder-close"></i><span class="hidden-tablet"> 考试设计</span></a></li>
						...
						<li><a class="ajax-link" href="javascript:void(0)" tar='ui'><i class="icon-folder-close"></i><span class="hidden-tablet"> 考试管理</span></a></li>
						...
						<li><a class="ajax-link" href="javascript:void(0)" tar='ui'><i class="icon-folder-close"></i><span class="hidden-tablet"> 监控管理</span></a></li>
						...
						<li><a class="ajax-link" href="javascript:void(0)" tar='ui'><i class="icon-folder-close"></i><span class="hidden-tablet"> 数据分析</span></a></li>
						...
						<li><a class="ajax-link" href="javascript:void(0)" tar='ui'><i class="icon-folder-close"></i><span class="hidden-tablet"> 系统管理</span></a></li>
		...
		<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">cdzhai</a> 2013</p>
			<p class="pull-right">Powered by: <a href="http://www.amarsoft.com">Amarsoft</a></p>
		</footer>
		<div style='display:none'>
			...
			<input type='button'id='del_error' class="btn btn-primary noty" data-noty-options='{"text":"删除失败","layout":"bottomLeft","type":"error"}'/>
		</div>
	</div>
