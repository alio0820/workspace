...
//										 	System.out.print(prb.getProjectID()+"\t");
											...
											out.print("<td width='216px'><a href='../index/departIndicatorDetails.jsp?prId="+pb.getProjectId()+"'>"+pb.getProjectName()+"[<font style='color:rgb(21.2%, 43.1%, 72.9%);'>详情</font>]</a></td>");
