...
<div class="zhong" >
  ...
  <div class="menu" >
    ...
    <div id="menu3" class="menusel">
      <h2><a href="leadProjectPS.jsp">项目管理</a></h2>
      <div class="position">
        <ul class="clearfix typeul">
	   	  <li><a href="leadProjectPS.jsp">领导批示</a></li>
		  <li class="lli"><a href="../index/projectInquires.jsp">搜索</a></li>
        </ul>
      </div>
    </div>    
  ...
  <div style="color:black;height:auto;">
  	<div id="dutyProject_top" style="height:20px;margin-bottom:10px">
        ...
        <div style="float:left;margin-left:100px"><span style="font-weight:bold">当前位置：</span>
                ...
                <a href="leadProjectPS.jsp" style="color:rgb(120,48,120);">领导批示</a>
        </div>
    </div>
