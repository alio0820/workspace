            					...
            					<%  int i=0;
									...
									for(DepartmentBean db:list){
										...
										if(db.getSecondClassify().equals(db_forward.getSecondClassify())){
											...
											out.println("<tr><td class='borderleft'><a href='IC_classify.action?dpId="+db.getDepartmentId()+"&evaId="+evaluationId+"&dpName="+db.getDepartmentName()+"'>"+db.getDepartmentName()+"</a></td>");	//小标题的子项
										}
										db_forward = db;
										i++;
									}
