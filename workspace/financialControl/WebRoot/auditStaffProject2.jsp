	...
	<HEAD>
		...
		<script type='text/javascript'>
			function check(link){
				...
				var isManProjectCheck;
				if(document.getElementsByName(Apply_ID)[0].checked)		//radio选中是属性
					isManProjectCheck='true';
				else
					isManProjectCheck='false';
				document.form1.action="manCheck_ManProCheckUpdate.action?Apply_ID="+Apply_ID+"&isManProjectCheck="+isManProjectCheck;
						...
						<TD
							...
							<form name='form1' method ='post' action ='appForm_insertForm.action'>
								...
								<%
									...
									ArrayList<ApplicationForm> list=manCheck.ManProCheck();
