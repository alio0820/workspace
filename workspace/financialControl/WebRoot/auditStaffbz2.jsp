		...
		<script type='text/javascript'>
			function check(link){
				...
				if(document.getElementsByName(Apply_ID)[0].checked)		//radio选中是属性
					...
					isManCheck='false';
				document.form1.action="manCheck_ManCheckUpdate.action?Apply_ID="+Apply_ID+"&isManCheck="+isManCheck;
					...
					<TR>
						...
						<TD
							...
							<form name='form1' method ='post' action ='appForm_insertForm.action'>
								...
								<%
									ManagementCheck manCheck=new ManagementCheck();
									manCheck.OpenDB();
									
									ArrayList<ApplicationForm> list=manCheck.ManCheck(); //调用manCheck（）方法，读取数据库审核表
