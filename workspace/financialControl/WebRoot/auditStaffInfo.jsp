		...
		<script type='text/javascript'>
			function check(link){
				...
				if(document.getElementsByName(Apply_ID)[0].checked)		//radio选中是属性
					...
					isFinApproval='false';
				document.form1.action="finApp_FinApprovalUpdate.action?Apply_ID="+Apply_ID+"&isFinApproval="+isFinApproval;
					...
					<TR>
						...
						<TD
							...
							<form name='form1' method ='post' action ='appForm_insertForm.action'>
								...
								<%
									FinancialApproval finapp=new FinancialApproval();
									finapp.OpenDB();
									
									ArrayList<ApplicationForm> list=finapp.FinApproval();
