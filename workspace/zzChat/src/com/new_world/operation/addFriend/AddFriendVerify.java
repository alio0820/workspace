...
public class AddFriendVerify
{
	private Map<String, String> feaMap = null;
	 ...
	 public AddFriendVerify(String name,ObjectOutputStream oos){
	  {
		  sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		  feaMap = new HashMap<String, String>();
		  feaMap.put("name", "NewWorld.zzChat");
		  feaMap.put("release", name+"想添加你为好友");
...
//      feaPan = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
	  ...
	  headPan = new JPanel();
     feaPan = new JPanel();
     feaPan.setBounds(0, 200, 320, 200);
	  title = new JLabel("添加好友");
...
//	  headImgLabel.setBounds(10,200,100, 100);
	  JButton jbtnVerify = new JButton("确定");
	  jbtnVerify.addMouseListener(new MouseAdapter()
	  {
		public void mousePressed(MouseEvent e)
		{
			PCMessage message = new PCMessage();
			message.setSender(MainDisplay.id);
			message.setSendTo(1);
...
//	  jbtnVerify.setBounds(10, 200, 50, 30);
...
//	  feature.setBounds(10, 200, 200, 50);
	  feaPan.add(jbtnVerify);
	  //增加鼠标拖动事件
...
//	  new AddFriendVerify(path,friendNoteName);
	 }
