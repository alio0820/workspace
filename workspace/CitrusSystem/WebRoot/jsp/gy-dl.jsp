							...
							<blockquote>
								...
								<table border="0" cellpadding="2" cellspacing="2" width="100%" style="font:18px">
									<tbody>
										<tr>
											<td width="51%">
											    <p><strong>绿色柑橘园地的道路系统规划</strong>
												<p>
													&nbsp;&nbsp;&nbsp;&nbsp;为了便于管理和提高作业效率，一般要对橘园进行道路系统的配置。在道路的布局上，要求运输方便，布局合理，
													运输距离短，造价低，并与小区规划、排灌系统、防护林系统、贮运设施及生活设施的规划布局相协调。集约化柑橘园的道路系统，包括主路、
													支路和小路。
												</p>
												<p>
												    &nbsp;&nbsp;&nbsp;&nbsp;主路：应直接与外界公路相通，园内与生活区、办公区、贮藏转运场等相连，并以最短路程贯通或环绕全园。主路上可
												    行驶汽车或大型拖拉机，宽度要求4m以上，在适当位置加宽至8～10m以便会车。主路末端是断头路时，应在末端处修筑回车场。山地果园的主路可以
												    盘山而上或呈之形上山，其坡度要小于5°～7°，转弯半径大于10m。主路以石块垫底，碎石铺面，有条件的地方可以修成混凝土或沥青油路面，主路
												    两边应设置排水沟和防护林。
												</p>
												<p>
												   &nbsp;&nbsp;&nbsp;&nbsp;支路：横贯于各小区之间，与主路相连，便于机动车或耕作机械通行。支路宽3～4m，最小转弯半径大于3m。山地果园的
												   支路一般沿等高线设置于山腰或山脚，坡度不超过12°。支路应铺设碎石路面，两边设排水沟和防护林。
												</p>
												<p>
												  &nbsp;&nbsp;&nbsp;&nbsp;小路：是贯通小区内各树行或梯田各台面的人行通道或小型耕作机行驶道，宽1～2m。平地果园的小路以一定间隔沿垂直
												  于树行的方向设置。山地果园的小路在小区内沿等高线横向及上下坡纵向，每距50m左右设置一条，构成路网。小路与支路或主路相通。小路的设置还应
												  与排灌沟及防护林系统配合。小路不能修在汇水线上。有条件的柑橘园可按纵坡方向设置单轨或双轨交通运输车道。沿江河湖滨或水网地带建立的柑橘园，
												  可以以水道网络代替道路运输系统，但要使水位至少低于1m，以保证果园有足够的有效土层厚度。全园道路系统的占地面积不应超过果园总面积的5％。
												</p>						
											</td>
