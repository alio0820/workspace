...
.btn_login{width:57px;height:57px;background:url(../image/web/btn_login.gif) no-repeat 0px 0px;border:0px;margin-left:20px;padding:0px;cursor:pointer;}
.btn_register{width:125px;height:53px;background:url(../image/web/btn_register.gif) no-repeat 0px 0px;border:0px;margin:0px;padding:0px;cursor:pointer;}
...
<script type="text/javascript" src="../js/web/ajax.js"></script>
...
function callback(xmlHttp){
	...
	if(text=="true"){
		emailMsg.innerHTML = "<span style='color:#f00;font-size:12px;'>该邮箱已被其他人注册！</span>";
	}else if(text=="false"){
		emailMsg.innerHTML = "<span style='color:#29D134;font-size:12px;'>该邮箱可以使用!</span>";
		isValidate = true;
	}else{
		emailMsg.innerHTML = "<span style='color:#f00;font-size:12px;'>请正确填写邮箱地址！</span>";
...
<body>
<iframe src="top_index.jsp?op=login" name="topFrame" width="100%" height="150px" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
<div id="middle_div">
	<div class="sitemap">
		您现在所在的位置：<a target="_top" href="index.html">网站首页</a>&nbsp;&gt;&nbsp;注册/登录
	</div>
	<div id="login_div">
		<img src="../image/web/login_logo.gif"  />
		<form name="loginForm" action="RegisterServlet" onSubmit="return checkLoginForm();" method="post" target="_top">
	...
	<div id="register_div">
		<img src="../image/web/register_logo.gif" align="left" />
