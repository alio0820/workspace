...
<HTML>
	<HEAD>
		...
		<% String  leadName =session.getAttribute("realName").toString();
		%>
		<script type='text/javascript'>
			function shenhe(projectId,taskMonth){
				...
				alert(tongguo);
				document.form1.action="projectR_shenheQianTouLeader.action?projectId="+projectId+"&taskMonth="+taskMonth+"&tongguo="+tongguo+"&yijian="+yijian;
							...
							<div style="margin-left:30px;margin-top:20px;">
								<table class='xiangmu' width='1150px' cellSpacing=0 cellPadding=4>
									...
									<%
										...
										ArrayList<QianTouViewBean> list=prm.QianTouLeaderViewList(leadName);
										for(QianTouViewBean prb:list ){
												...
												out.println("<td width='150px'>"+prb.getLeadCompanyView()+"</td>");
