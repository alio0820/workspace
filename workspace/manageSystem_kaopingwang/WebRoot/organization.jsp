	...
	<HEAD>
		...
		<script type='text/javascript'>
			...
			function createtable(){
				...
				var table1 = document.getElementById('departfenlei');
				...
				var td_yuanqu = [];
				var td_xiangz = [];
				var long1 = departList['区级部门'].length;
				var long2 = departList['园区管委会'].length;
				var long3 = departList['乡镇街道'].length;
				for(var i=0;i<(long1/13);i++){
					tr_quji[i]=document.createElement('tr');
					for(var j=0;j<13;j++)
						{
							td_quji[j]=document.createElement('td');
							
							td_quji[j].innerHTML="nihao";
							tr_quji[i].appendChild(td_quji[j]); 
						}
						alert(tr_quji[0].innerHTML);
					tbody.appendChild(tr_quji[i]);		
				}
				table.appendChild(tbody);
				for(var i=0;i<(long2/13);i++)
					tr_yuanqu[i]=document.createElement('tr');
				for(var i=0;i<(long3/13);i++)
					tr_xiangz[i]=document.createElement('tr');
			}
		</script>
		</HEAD>
					...
					<TR>
						...
						<TD
							...
							<div style='margin-left:30px'>
								<!-- <table id='departfenlei' class='xiangmu' cellSpacing=0 cellPadding=4>
									<tbody id='tbody1'>
									<tr>
								...
								<%out.println("<table class='xiangmu' cellSpacing=0 cellPadding=4 >");
									out.print("<tr><th colspan='13' style='background:#91C7E1'><center><span>区级部门</span><span><a id='a' href='javascript:void(0)' onclick='hideClass(");
									out.print('"'+"quji"+'"'+','+'"'+"a"+'"');
