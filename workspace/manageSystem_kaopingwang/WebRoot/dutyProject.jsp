				...
				<TBODY>
					...
					<TR>
						...
						<TD
							...
							<div>责任项目总览(第<%=new java.util.Date().getMonth() %>月份)</div>
							
							<div style="margin-left:30px;margin-top:20px;">
								<table class='xiangmu' width='1200px' cellSpacing=0 cellPadding=4>
									...
									ArrayList<ProjectRecordBean> list=prm.getResponsibleDepartmentTask(departmentId, 5,"%");
									if(list.size()==0)
...
//										out.print(prb.getProjectID()+"\t");
										...
										if(status==null){
											...
											out.print("<td ><span>-</span></td>");
											out.print("<td ><span>-</span></td>");
											out.println("<td ><span><a href='xiangmu_xiangqing.jsp?projectId="+prb.getProjectID()+"'>未申报</a></span></td>");
										}else{
											out.print("<td ><span>"+prm.CTS(status,0)+"</span></td>");
											out.print("<td ><span>"+prm.CTS(status,1)+"</span></td>");
											out.print("<td ><span>"+prm.CTS(status,2)+"</span></td>");
											out.println("<td ><span><a href='xiangmu_xiangqing.jsp?projectId="+prb.getProjectID()+"'>已申报</a></span></td>");
										}
									...
									<tr>
										<td width='200px' class='borderleft'>
											<span>博赛集团先锋氧化铝环保节能技改项目</span>
										</td>
										<td>
											<span>投资计划：银行贷款35000元，业主自筹10000元，其他45000元</span>
										</td>
										<td>
											<span>发改委</span>
										</td>
									...
									<tr>
										...
										<td>
											<span>投资计划：银行贷款35000元，业主自筹15000元，其他50000元</span>
										</td>
										<td>
											<span>发改委</span>
										</td>
										<td>
											<span id='jindu_bar' style='background:white;width:200px;height:20px;border:1px solid #91C7E1;'>
												<span id='jindu' style='background:#91C7E1;width:130px;height:20px;float:left'>
													65%
												</span>
											</span>
										</td>
									...
									<tr>
										<td width='200px' class='borderleft'>
											<span>鸿都泰富塑钢铝型材生产加工项目</span>
										</td>
										<td>
											<span>投资计划：银行贷款15000元，业主自筹5000元，其他20000元</span>
										</td>
										<td>
											<span>发改委</span>
										</td>
										<td>
											<span id='jindu_bar' style='background:white;width:200px;height:20px;border:1px solid #91C7E1;'>
												<span id='jindu' style='background:#91C7E1;width:180px;height:20px;float:left'>
													90%
												</span>
											</span>
										</td>
