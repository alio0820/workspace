...
.ResultM_1 {
	background: url(images/projectInquires.png);
	width: 362px;
	height: 57px;
	float: left;
}
		...
		<DIV>
			<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%"
				...
				<TBODY>
					...
					<TR>
						...
						<TD
							...
							<form name='form1' method='post'>
								<div
									style="background: url(images/ResultManager_2.png); width: auto; height: 57px;">
								...
								<br />
								<div
									style='width: 640px; height: auto; border: 1px solid rgb(119, 119, 170); padding-top: 5px; padding-left: 10px; padding-right: 10px; margin-left: 30px;'>
									<div>
										<span>请选择查询方式：</span>
								...
								<div id='query_bumen'
									style='width: 640px; height: 90px; border: 1px solid rgb(119, 119, 170); border-top: none; padding: 10px; margin-left: 30px;'>
									<div class='new'>
										选择级别：
								...
								<div id='query_mingcheng'
									style='width: 640px; height: 90px; border: 1px solid rgb(119, 119, 170); border-top: none; padding: 10px; margin-left: 30px; display: none;'>
									<div class='new'>
										<span>请输入项目名：</span>
								...
								<div
									style='width: 1022px; height: auto; border: 1px solid rgb(119, 119, 170); padding-top: 5px; padding-left: 10px; padding-right: 10px; margin-left: 30px;'>
									<span>查询结果</span>
								...
								<div id='query_list'
									style='width: 1000px; height: auto; border: 1px solid rgb(119, 119, 170); border-top: none; padding: 20px; margin-left: 30px;'>
									<table class='xiangmu' width='980px' cellSpacing=0
										cellPadding=4>
					...
					<TR
						style="BACKGROUND-IMAGE: url(images/main_fs.gif); background-color: rgb(255, 255, 255); BACKGROUND-REPEAT: repeat-x"
						height=10>
						<TD
							style="BACKGROUND-IMAGE: url(images/main_lf.gif); BACKGROUND-REPEAT: no-repeat; width: 10px"></TD>
