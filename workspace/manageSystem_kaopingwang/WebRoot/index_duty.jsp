...
<div class="zhong" >
  ...
  <div class="menu" >
    ...
    <div id="menu1" class="menusel">
      <h2><a href="qujikaoping.jsp">部门分类</a></h2>
      <div class="position">
    ...
    <div id="menu2" class="menusel">
      <h2><a href="kaohezhibiao.jsp">指标浏览</a></h2>
      <div class="position">
        <ul class="clearfix typeul">
        </ul>
      </div>
    ...
    <div id="menu3" class="menusel">
      <h2><a href="xiangqing.hjsp">项目管理</a></h2>
      <div class="position">
        <ul class="clearfix typeul">
          <li><a href="#">责任项目</a></li>
          <li><a href="#">进度申报</a></li>
          <li><a href="#">重新申报</a></li>
          <li class="lli"><a href="#">搜索</a></li>
        </ul>
      </div>
    </div>    
  ...
  <div style="color:black;height:auto;">
  	<div id="qujikaoping_top" style="height:20px;margin-bottom:10px">
        ...
        <div style="float:left;margin-left:100px"><span style="font-weight:bold">当前位置：</span>
                ...
                <a href="kaohezhibiao.jsp" style="color:rgb(120,48,120);">项目入口</a>
        </div>
    </div>
    <div id="right" style="width:976px;height:auto;margin:0 10px 5px 10px;border:1px solid lightblue;min-height:500px;">      
									...
									<tr style='background:#6699CC ' style='width:30px'>
								...
								<%
									...
									for(EvaluationFormBean efb:list){
										...
										out.println("<td width='700px'>"+efb.getStandard()+"</td>");
