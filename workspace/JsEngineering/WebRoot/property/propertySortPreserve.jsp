...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      function biao()
      {
          //passForm.str.value=document.getElementsByName()
          document.passForm.action="proqueryUser.action";
...
<body onload="loading();">
    ...
    <s:form name= "form1" method="post"   action="property.action">
     <table style="width: 63%;"align="center" border="1">
        <tr align="center">
            <td class="style7" colspan="2" bgcolor="#275c98">资产类别维护</td>
        </tr>
        <tr>
            <td class="style9" bgcolor="#99ccff">资产类别编号*</td>
            <td class="style8"><input type="text" name="num" id="num" style="width:100%;"></td>
        </tr>
        <tr>
             <td class="style9" bgcolor="#99ccff">资产类别名称*</td>
    ...
    <p align="center">
     ...
     <table style="width: 63%;" border="1" align="center">
        <tr align="center" >
            <td class="style6" colspan="4"  bgcolor="#275c98" >资产类型列表</td>
        </tr>
        <tr align="center" bgcolor="#99ccff">
            <td class="style1">&nbsp;</td>
            <td class="style2">资产类别编号</td>
            <td >资产类别名称</td>
            <td>&nbsp;</td>
        </tr>
