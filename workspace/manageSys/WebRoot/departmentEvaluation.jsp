...
//									int departmentId=Integer.parseInt(session.getAttribute("departmentId").toString());	
									...
									ArrayList<EvaluationFormBean> list=efm.searchEvaluationByDepartment(departmentId);
									
									for(EvaluationFormBean efb:list){
										out.print("<tr><td width='60px' class='borderleft'>"+efb.getEvaluationID()+"</td>");
										out.print("<td width='200px'><a href='departmentDuty.jsp?classify="+efb.getTopClass()+"&departmentId="+departmentId+"'>"+efb.getTopClass()+"[<font style='color:rgb(21.2%, 43.1%, 72.9%);'>详情</font>]</a></td>");
