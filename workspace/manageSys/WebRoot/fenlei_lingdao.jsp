...
<html>
	<head>
		...
		<script type='text/javascript'>
			function test(){
				var str = "<div><textarea name='lingdao_ps'></textarea><br/><input type='button' onclick='aa(lingdao_ps.value)'value='按钮'></div>";
...
//										 	out.print("<tr><td width='100px' class='borderleft'>"+prb.getFirstClassify()+"</td>");
											...
											out.println("<td width='80px'><input type='button' value='给予批示' onclick='test()'/></td></tr>");
