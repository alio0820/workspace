<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%><%@ page contentType="text/html;charset=UTF-8"%><%@ page import = "Xproer.*" %><%@ page import="org.apache.commons.lang.StringUtils" %><%@ page import="com.jspsmart.upload.*" %>
<%
/*
	只负责拼接文件块。
	此页面一般由控件负责调用
