		...
		<f:view>
			<h:form id="addform">
				...
				<h:selectOneRadio id="dtabbreviation"
					value="#{dataTypeModel.dtabbreviation}" border="1"
					layout="lineDirection" style="width:50%">
				...
				<h:panelGrid>
					...
					<h:selectBooleanCheckbox id="dtstatus" value="#{dataTypeModel.dtstatus}"/>
				</h:panelGrid>
				<br>
				<h:panelGrid>
				...
				<h:commandButton action="backList"
					actionListener="#{dataTypeModel.saveDataType}" id="Save"
