...
<jsp:setProperty name="selectaddcoinBean" property="status" param="status"/>
                ...
                <tr>
                    <td height="25" align="left" bgcolor="#FFFFFF">
                       <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                              <td height="40" align="left" valign="buttom" class="q03"><span class="scal_content04">查询</span></td>
                          </tr>
                       </table>
                    </td>
                </tr>
