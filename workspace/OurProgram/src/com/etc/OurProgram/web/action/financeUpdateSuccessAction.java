...
import com.etc.OurProgram.service.impl.financeUpdateSuccessServiceImpl;

public class financeUpdateSuccessAction {
    private int Id;
	...
	public String updatesuccess(){
		boolean bool=false;
		financeUpdateSuccessService u=new financeUpdateSuccessServiceImpl();
		bool=u.updateSucess(Id, Date, Own_project, Money, Borrow_object, Pay_way, Government_buystyle, Government_buysite, ProofID, Contract_special, Summary, Haber_subject, Project_manage, Government_buyway, Government_buyclassify, IsSubmit);
		if(bool)
		return "success";
		else
	    return "false";
