...
import com.etc.OurProgram.service.impl.financeInsertServiceImpl;
import com.opensymphony.xwork2.ActionSupport;

public class financeInsertAction extends ActionSupport {
	private String Date;
	...
	public String insert() throws ClassNotFoundException, SQLException{
		  financeInsertService i=new financeInsertServiceImpl();
		  boolean bool=i.insert(Date,Own_project,Money,Borrow_object,Pay_way,Government_buystyle,Government_buysite,ProofID,Contract_special,Summary,Haber_subject,Project_manage,Government_buyway,Government_buyclassify,IsSubmit);
		  if(bool){
		  return "success";}
		  else{
		  return "false";
