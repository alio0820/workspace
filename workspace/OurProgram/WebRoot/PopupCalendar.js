...
function PopupCalendar(InstanceName){
	...
	this.weekDaySting=new Array("天","一","二","三","四","五","六");
...
function CalendarInit()				///Create panel
{
	...
	htmlAll="<div id='"+this.sDIVID+"' style='display:none;position:absolute;width:180px;border:"+this.divBorderCss+";padding:2px;background-color:#FFFFFF'>";
