...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      {
          form1.str.value="2";
          form1.action="fileSort.action?pageNow="+form1.nnn.value;
          document.form1.submit();
      }
      function loading()
       {
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="10" topmargin="10" onload="loading();">
    ...
    <s:form name= "form1" method="post"   action="fileSort.action">
     ...
     <table border="0" valign="top" width="95%" align="center" cellspacing="1" bordercolorlight="#003366" bordercolordark="#DFDFFF" bgcolor="#426199">
        <tr bgcolor="#6699CC">
        <td height="25" colspan="8" align="center"><strong><font color="#FFFFFF" size="4">归档类别维护</font></strong></td>
         
        </tr>
        <tr class="lc2" bgcolor="#EEF4FF">
            <td width="21%" height="25"><div align="left">归档类别编号*</div></td>
            <td width="37%"><input type="text" name="num" id="num" style="width:100%;"></td>
        </tr>
        <tr class="lc2" bgcolor="#EEF4FF">
             <td width="21%" height="25"><div align="left">归档类别名称*</div></td>
        ...
        <tr>              
             <td><input id = 'test2' type = 'hidden' name="str" value="1"> 
                 ...
                 <input name="nnn" type="hidden" value="<s:property value="nnn"/>"/>
             </td>
        </tr>
    </table>   
    <p align="center">
     ...
     <table border="0" valign="top" width="95%" align="center" cellspacing="1" bordercolorlight="#003366" bordercolordark="#DFDFFF" bgcolor="#426199">
        <tr bgcolor="#6699CC" >
        <td height="25" colspan="8" align="center"><strong><font color="#FFFFFF" size="4">归档类别</font></strong></td>
           
        </tr>
        <tr bgcolor="#A6D0F2">
            <td height="25" align="center" width="5%">&nbsp;</td>
            <td width="21%" height="25" align="center">归档类别编号</td>
            <td width="21%" height="25" align="center">>归档类别名称</td>
            <td height="25" align="center" width="5%">&nbsp;</td>
        </tr>
		...
		<tr bgcolor="#A6D0F2">
             ...
             <td height="25" align="center" width="5%"> 
                  ...
                  <a href="fileSort.action?id=<s:property  value="id"/>& nnn=<s:property  value="pageNow"/>&str=1&p_name=<s:property  value="name"/>">[维护下一级]</a>
             </td>
        </tr>
	    </s:iterator>	                    
        </table>
