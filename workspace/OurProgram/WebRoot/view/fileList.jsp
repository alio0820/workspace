...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="1" bordercolorlight="#003366" bordercolordark="#DFDFFF" bgcolor="#426199">
  ...
  <tr class="lc2" bgcolor="#EEF4FF">
    ...
    <img src="../images/clip.gif" onClick="getPopValue(belongedPrj, '../project/miniPrjList0.htm')" style="cursor:pointer "/></td>
  </tr>
</table>
<p align="center">  <img src="../images/find.gif"  onClick="alert('查询')" style="cursor:pointer "/>&nbsp;  &nbsp;</p>
</body>
</html>
