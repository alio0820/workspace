...
One.addTree("自行组织集中采购机构采购","../images/tree_level_0.gif","true","自行组织集中采购机构采购","#","mainFrame","");
One.addTree("委托组织集中采购机构采购","../images/tree_level_0.gif","true","委托组织集中采购机构采购","#","mainFrame","");
One.addTree("自行组织部门集中采购","../images/tree_level_0.gif","true","自行组织部门集中采购","#","mainFrame","");
One.addTree("委托组织部门集中采购","../images/tree_level_0.gif","true","委托组织部门集中采购","#","mainFrame","");
One.addTree("自行组织分散采购","../images/tree_level_0.gif","true","自行组织分散采购","#","mainFrame","");
One.addTree("委托组织分散采购","../images/tree_level_0.gif","true","委托组织分散采购","#","mainFrame","");
