...
One.addTree("财政直接支付","../images/tree_level_0.gif","true","财政直接支付","#","mainFrame","");
One.addTree("财政授权支付","../images/tree_level_0.gif","true","财政授权支付","#","mainFrame","");
One.addTree("实拨资金","../images/tree_level_0.gif","true","实拨资金","#","mainFrame","");
