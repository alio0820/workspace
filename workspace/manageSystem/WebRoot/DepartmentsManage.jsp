	...
	<HEAD>
		...
		<script type='text/javascript'>
		    ...
		    {alert('df');
		        ...
		        document.form1.action="departM.action?fenlei="+value;
				...
				<TBODY>
					...
					<TR>
						...
						<TD
							...
							<div id='div_new' style='width:600px;height:200px;border:1px solid rgb(119,119,170);border-top:none;padding-left:10px;margin-left:30px;'>
								<div>新增一个部门：</div><br/>
								<div class='new'>选择分类：
								...
								<div class='new'>
									<input type='button' style="width:46px;height:25px;" value='确定' onclick='depart_new()'/>
								</div>
							</div>
